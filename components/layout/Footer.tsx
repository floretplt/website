...
export async function Footer({ settings }: Props) {
  ...
  return (
    <footer className="border-t border-ink/10 bg-ink text-bg">
      <div className="mx-auto grid max-w-6xl gap-12 px-4 py-14 sm:px-6 sm:py-16 md:grid-cols-3 md:px-10">
        <div>
          ...
          <a
            ...
            className="mt-4 inline-flex items-center gap-2 text-sm uppercase tracking-[0.12em] text-bg/90 transition-colors hover:text-bg md:text-xs md:tracking-[0.15em]"
          >
        ...
        <div className="text-sm text-bg/85">
          ...
          <div className="mt-8 flex flex-col gap-3">
            <Link
              href="/order"
              className="inline-block text-sm font-medium uppercase tracking-[0.12em] text-bg underline-offset-4 hover:underline md:text-xs md:tracking-[0.15em]"
            >
              Замовити
            </Link>
            <Link
              href="/order-status"
              className="inline-block text-sm font-medium uppercase tracking-[0.12em] text-bg/90 underline-offset-4 hover:underline md:text-xs md:tracking-[0.15em]"
            >
              Статус замовлення
            </Link>
          </div>
      ...
      <div className="border-t border-bg/10 px-4 py-6 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] text-center text-sm uppercase tracking-[0.14em] text-bg/50 sm:px-6 md:text-[11px] md:tracking-[0.2em]">
